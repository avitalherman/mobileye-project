...
def crop_image(x, y, img, tav):
    ...
    tfl_path = r"C:\Users\avita\Desktop\Bootcamp\mobileye\val\tfl"
    not_tfl_path = r'C:\Users\avita\Desktop\Bootcamp\mobileye\val\not tfl'
    im = Image.open(img)
    plt.imshow(im)
...
def main():
    ...
    path_png = r"C:\Users\avita\Desktop\Bootcamp\mobileye\leftImg8bit\val"
    path_json = r"C:\Users\avita\Desktop\Bootcamp\mobileye\gtFine_trainvaltest\gtFine\val"
